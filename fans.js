...
const FANS_DATA = [
    ...
    // 24番 (9种)
    { id: 'qidui', name: '七對', score: 24, desc: '由7個對子組成的和牌 🀈🀈 🀌🀌 🀒🀒 🀖🀖 🀞🀞 🀠🀠 🀁🀁', exclusion: ['buqiuren', 'dandiaojiang', 'menqianqing'] },
    { id: 'qixingbukao', name: '七星不靠', score: 24, desc: '東南西北中發白+不相鄰序數牌 🀀🀁🀂🀃🀄🀅🀆 🀇🀊🀍 🀑🀔🀗 🀛', exclusion: ['wumenqi', 'buqiuren', 'dandiaojiang', 'menqianqing'] },
    { id: 'quanshuangke', name: '全雙刻', score: 24, desc: '全由偶數組成的碰碰和 🀈🀈🀈 🀊🀊🀊 🀌🀌🀌 🀗🀗🀗 🀜🀜', exclusion: ['pengpenghe', 'duanyao'] },
    { id: 'qingyise', name: '清一色', score: 24, desc: '全由同一種花色的序數牌組成 🀇🀇🀇 🀈🀉🀊 🀌🀍🀎 🀏🀏🀏 🀎🀎', exclusion: ['wuzi'] },
    { id: 'yisesantongshun', name: '一色三同順', score: 24, desc: '一種花色3副序數相同的順子 🀇🀈🀉 🀇🀈🀉 🀇🀈🀉', exclusion: ['yisesanjiegao', 'yibangao'] },
    { id: 'yisesanjiegao', name: '一色三節高', score: 24, desc: '一種花色3副依次遞增一位數字的刻子 🀇🀇🀇 🀈🀈🀈 🀉🀉🀉', exclusion: ['yisesantongshun'] },
    { id: 'quanda', name: '全大', score: 24, desc: '全由7、8、9組成 🀍🀎🀏 🀏🀏🀏 🀗🀗🀗 🀟🀠🀡 🀠🀠', exclusion: ['wuzi', 'dayuwu'] },
    { id: 'quanzhong', name: '全中', score: 24, desc: '全由4、5、6組成 🀊🀊🀊 🀋🀋🀋 🀜🀝🀞 🀔🀔🀔 🀕🀕', exclusion: ['duanyao'] },
    ...
    // 6番 (7种)
    { id: 'pengpenghe', name: '碰碰和', score: 6, desc: '由4副刻子（或槓）、將牌組成的和牌 🀌🀌🀌 🀓🀓🀓 🀚🀚🀚 🀟🀟🀟 🀁🀁', exclusion: [] },
    { id: 'hunyise', name: '混一色', score: 6, desc: '由一種花色序數牌及字牌組成的和牌 🀇🀇🀇 🀈🀉🀊 🀌🀍🀎 🀏🀏🀏 🀀🀀', exclusion: [] },
    ...
    // 2番 (10种)
    { id: 'jianke', name: '箭刻', score: 2, desc: '有中發白刻子 🀄🀄🀄', exclusion: [] },
    ...
    { id: 'angang', name: '暗槓', score: 2, desc: '1副暗槓，全自己抓 🀇🀇🀇🀇', exclusion: [] },
    { id: 'duanyao', name: '斷幺', score: 2, desc: '和牌中沒有1、9及字牌(東南西北中發白)', exclusion: [] },

    // 1番 (13种)
    { id: 'yibangao', name: '一般高', score: 1, desc: '一種花色2副相同的順子 🀇🀈🀉 🀇🀈🀉', exclusion: [] },
    { id: 'xixiangfeng', name: '喜相逢', score: 1, desc: '2種花色2副序數相同的順子 🀇🀈🀉 🀐🀑🀒', exclusion: [] },
    { id: 'lianliu', name: '連六', score: 1, desc: '同花色6張相連順子 🀈🀉🀊 🀋🀌🀍', exclusion: [] },
    { id: 'laoshaofu', name: '老少副', score: 1, desc: '同花色123+789 🀇🀈🀉 🀍🀎🀏', exclusion: [] },
    { id: 'yaojiuke', name: '幺九刻', score: 1, desc: '3張1或9序数牌或非門風圈風的風牌 🀇🀇🀇', exclusion: [] },
    { id: 'minggang', name: '明槓', score: 1, desc: '1副明杠 🀇🀇🀇🀇', exclusion: [] },
    { id: 'queyimen', name: '缺一門', score: 1, desc: '和牌中缺少一種花色序數牌，如只有萬和餅', exclusion: [] },
    { id: 'wuzi', name: '無字', score: 1, desc: '和牌中沒有字牌(東南西北中發白)', exclusion: [] },
    { id: 'bianzhang', name: '邊張', score: 1, desc: '單和123的3或789的7 🀇🀈和🀉', exclusion: [] },
    { id: 'kanzhang', name: '坎張', score: 1, desc: '和順子中間的牌 🀇🀉和🀈', exclusion: [] },
    { id: 'dandiaojiang', name: '單釣', score: 1, desc: '釣單張牌作將 🀇和🀇', exclusion: [] },
    { id: 'zimo', name: '自摸', score: 1, desc: '自己抓牌和', exclusion: [] },
    { id: 'huapai', name: '花牌', score: 1, desc: '即春夏秋冬梅蘭竹菊，每花計一分', exclusion: [] }
];
